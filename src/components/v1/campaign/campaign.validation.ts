...
export const createCampaignSchema = z.object({
  ...
  target_amount: z
    .string()
    .trim()
    .refine((s) => isPositiveU256String(s), "target_amount must be a positive u256 integer string"),
  donation_token: z
    .string()
    .trim()
    .refine((s) => isValidStarknetAddress(s), "donation_token must be a valid contract address"),
})
