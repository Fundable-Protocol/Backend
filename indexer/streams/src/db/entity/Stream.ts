...
export class Stream {
  ...
  @Column({
    type: "bigint",
    comment: "The total amount of tokens in the stream",
  })
  totalAmount!: string;

  @Column({
    type: "bigint",
    comment: "The start time of the stream as unix timestamp",
  })
  startTime!: string;

  @Column({
    type: "bigint",
    comment: "The end time of the stream as unix timestamp",
  })
  endTime!: string;
  ...
  @Column({
    type: "bigint",
    default: "0",
    comment: "Total amount withdrawn so far",
  })
  ...
  @Column({
    type: "boolean",
    default: false,
    comment: "Whether the stream was canceled",
  })
  canceled!: boolean;
